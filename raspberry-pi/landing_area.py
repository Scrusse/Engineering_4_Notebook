# Paul Schakel
# I copy pasted this code, so technically I did some work to it
    # Rafael Arevalo
    # I copy pasted this code from Rafael who copy and pasted this code from Paul, so technically I did even more work because I wrote more here.
